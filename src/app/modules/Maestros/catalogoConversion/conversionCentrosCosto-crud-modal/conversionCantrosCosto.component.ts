...
export class conversionCantrosCostoModalComponent implements OnInit {
  public command!: CrudCommand<CatalogoConversionEntidad>;
  ...
  public formGroup: FormGroup = this._formBuilder.group({
    id: [0, []],
    idTabla: [0, []],
    conjuntoConversion: ['', [Validators.required]],
    codigoConversion: ['', [Validators.required]],
    equivalenciaConversion: ['', [Validators.required]],
    conjuntoRelacionado: ['', [Validators.required]],
    valorRelacionado: ['', [Validators.required]],
  ...
  private InitCommandHandler: CrudHandler = {
    ...
    EDIT: (CatalogoConversionEntidad: CatalogoConversionEntidad) => {
      this.formGroup.reset(CatalogoConversionEntidad);
    },
    DELETE: (CatalogoConversionEntidad: CatalogoConversionEntidad) => {
      this.formGroup.reset(CatalogoConversionEntidad);
    },
  };
  ...
  public get area() {
    console.log(this.command.parameters.codigoConversion)
    return this.command.parameters.codigoConversion;
  ...
  private get createRequest(): CatalogoConversionCreacion {
    this.formGroup.get('')
    let creationRolRequest: CatalogoConversionCreacion = this.formGroup.value;
    return creationRolRequest;
  }

  private get rolRequest(): CatalogoConversionEntidad {
    let updateRolRequest: CatalogoConversionEntidad = this.formGroup.value;
  ...
  ngOnInit(): void {
    ...
    this.GetUsuarios() 
    this.command = this._dynamicDialogConfig.data as CrudCommand<CatalogoConversionEntidad>;
