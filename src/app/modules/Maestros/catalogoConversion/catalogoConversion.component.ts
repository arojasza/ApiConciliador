...
import { CatalogoConversionEntidad, CatalogoConversionParameters,  } from './Interfaces/catalogoConversion.interfaces';
...
@Component({
  ...
  imports: [
    ...
    ConfirmDialogModule,
    StatusChipComponent],
  templateUrl: './catalogoConversion.component.html',
  providers: [DialogService, MessageService, CustomMessageService, ConfirmationService],
})
export class CatalogoConversion implements OnInit {
  public loadingTable: boolean = false;
  public pageTitle: string = 'Parametrización de catalogos de conversión';
  public viewDescription: string = 'Realiza búsquedas de manera agil por medio de los siguientes filtros';
  public Areas: Array<CatalogoConversionEntidad> = [];
  public paginatedAreas: Paginated<CatalogoConversionEntidad> = {
    totalPages: 0,
    totalCount: 0,
    result: []
  };
  ...
  ConfirmCreateDialog() {
    let data: CrudCommand<CatalogoConversionParameters> = {
      method: 'CREATE',
      parameters: {
        area: null
      },
  ...
  ConfirmEditDialog(report: CatalogoConversionEntidad) {
    let data: CrudCommand<CatalogoConversionEntidad> = {
      method: 'EDIT',
      parameters: report
    };
  ...
  ConfirmDeleteDialog(report: CatalogoConversionEntidad) {
    let data: CrudCommand<CatalogoConversionEntidad> = {
      method: 'DELETE',
      parameters: report
    };
